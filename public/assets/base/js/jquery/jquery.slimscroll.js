        ...
        slimScroll: function(f) {
            ...
            this.each(function() {
                ...
                if (b.parent().hasClass(a.wrapperClass)) {
                    ...
                    window.addEventListener ? (this.addEventListener("DOMMouseScroll", v, {capture: false, passive: false}), this.addEventListener("mousewheel", v, {capture: false, passive: false})) : document.attachEvent("onmousewheel", v)
                }
            });
            return this
        }
